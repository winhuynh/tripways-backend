...
('44000000-0000-4000-8000-000000000001','30000000-0000-4000-8000-000000000003','en-GB','currency','Currency','Thai baht is the local currency.','{"code":"THB"}','https://www.bot.or.th/','2026-08-03','published','00000000-0000-4000-8000-000000000001');
...
('46000000-0000-4000-8000-000000000001','40000000-0000-4000-8000-000000000003','43000000-0000-4000-8000-000000000001','en-GB','wifi','Airport Wi-Fi','Wi-Fi is available in the terminal.',NULL,'https://www.bangkokairportonline.com/','2026-08-03','published',1,'00000000-0000-4000-8000-000000000001');
...
('81200000-0000-4000-8000-000000000001','city_route','ho-chi-minh-city-to-london','en-GB','/flights/ho-chi-minh-city-to-london','Flights from Ho Chi Minh City to London','review',FALSE,'development_fixture',NULL,'2026-08-03');
INSERT INTO public.route_pages(id,pseo_page_id,origin_city_id,destination_city_id,locale,h1,subheadline,seo_title,meta_description,intro,content_reviewed_at) VALUES
('82200000-0000-4000-8000-000000000001','81200000-0000-4000-8000-000000000001','30000000-0000-4000-8000-000000000001','30000000-0000-4000-8000-000000000004','en-GB','Flights from Ho Chi Minh City to London','Compare direct and connecting flight routes, schedules and estimated price ranges.','Ho Chi Minh City to London flights | Tripways','Explore direct and indirect routes from Ho Chi Minh City to London.','This page compares stored route patterns, not live availability.','2026-08-03');
...
('82200000-0000-4000-8000-000000000001','en-GB','timezone','Time difference','Check local time when planning connections.','https://www.gov.uk/when-do-the-clocks-change','2026-08-03','published',1,'00000000-0000-4000-8000-000000000001');
