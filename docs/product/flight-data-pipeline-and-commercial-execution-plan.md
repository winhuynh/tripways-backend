...
- **Tự động ẩn các thành phần giá:** Ẩn nhãn giá sàn (_"from $..."_), ẩn huy hiệu _"LOWEST FARE"_, chuyển trạng thái giá của card sang `unavailable`.
...
2. **Minh bạch thông tin (Affiliate Disclosure):** Mọi trang đều hiển thị thông báo rõ ràng:
   > _"Giá hiển thị là mức giá quan sát tham khảo gần đây, không phải giá bán cam kết. Giá chính xác và tình trạng chỗ sẽ được xác nhận khi hoàn tất đặt vé tại đối tác."_
